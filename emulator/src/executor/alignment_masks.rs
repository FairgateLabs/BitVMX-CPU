...
pub fn get_mask_round_1(instruction: &Instruction, alignment: u32) -> (u32, u32, i8)  {
    match instruction {
        Sb(_) => {
            match alignment {
                3 => (0xFFFF_FF00, 0x0000_00FF, 0),
                2 => (0xFFFF_00FF, 0x0000_00FF, 1),
                1 => (0xFF00_FFFF, 0x0000_00FF, 2),
                0 => (0x00FF_FFFF, 0x0000_00FF, 3),
                _=> panic!("Unreachable"),
            }
        },
        Sh(_) => {
            match alignment {
                ...
                2 => (0xFFFF_0000, 0x0000_FFFF, 0),
                1 => (0xFF00_00FF, 0x0000_FFFF, 0),
                0 => (0x0000_FFFF, 0x0000_FFFF, 0),
                _=> panic!("Unreachable"),
            }
        },
        Sw(_) => {
            match alignment {
                3 => (0xFFFF_FF00, 0xFF00_0000, -3),
                2 => (0xFFFF_0000, 0xFFFF_0000, -2),
                1 => (0xFF00_0000, 0xFFFF_FF00, -1),
                _=> panic!("Unreachable"),
            }
        },
        _ => panic!("Unreachable"),
...
pub fn get_mask_round_2(instruction: &Instruction, alignment: u32) -> (u32, u32, i8)  {
    match instruction {
        ...
        Sw(_) => {
            match alignment {
                3 => (0x0000_00FF, 0x00FF_FFFF, 1),
                2 => (0x0000_FFFF, 0x0000_FFFF, 2),
                1 => (0x00FF_FFFF, 0x0000_00FF, 3),
                _=> panic!("Unreachable"),
            }
        },
        _ => panic!("Unreachable"),
